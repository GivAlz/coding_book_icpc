...
\begin{itemize}
    \item Is it sufficient to simply adopt requests from the left? \dingright{} Not necessarily (there are counterexamples).
    \item Short line segments are less likely to overlap with others. Is it sufficient to adopt requests starting with the shortest line segments? \dingright{} Not necessarily (there are counterexamples).
\end{itemize}
